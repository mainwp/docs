...
| Add-on license keys | Required if reactivation is needed after migration |
| Add-on settings | Export using built-in import/export features where available |
...
<Step title="Verify add-ons">
Confirm all add-ons appear and are activated.
</Step>
</Steps>

### Reconnect Add-ons

If add-ons show as deactivated, go to **MainWP > Add-ons**, enter your API credentials, and reactivate any add-ons that require license verification.
...
- [ ] Add-on license keys documented
- [ ] Dashboard accessible at new location
- [ ] Add-ons activated and functioning
