...
[Install](/dashboard/overview/manage-extensions#install-add-ons) the [Custom Dashboard Extension](https://mainwp.com/extension/mainwp-custom-dashboard-extension/).
</Step>
