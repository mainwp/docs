...
[Install](/dashboard/overview/manage-extensions#install-add-ons) the [Custom Dashboard Extension](https://mainwp.com/extension/mainwp-custom-dashboard-extension/) (free).
</Step>
...
Use this method if you prefer not to install an add-on.
