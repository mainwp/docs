...
description: >-
  ...
  Create new users, edit existing users, change roles, import users via CSV,
  and delete users remotely.
---

The Manage Users feature lets you control WordPress user accounts across all your child sites from a central location. Create new users on multiple sites at once, edit existing user details, import users via CSV, and remove user accounts without logging into each site individually.
...
<iframe
  ...
  src="https://www.youtube.com/embed/vfZFneUTtJw"
  title="Manage WordPress Users and Passwords with MainWP"
  frameBorder="0"
...
<div id="bulk-update-admin-passwords"></div>

To change the password for the connected administrator account on selected Child Sites, go to [Admin Passwords](/sites/users/admin-passwords).
...
- [Admin Passwords](/sites/users/admin-passwords) - Change the connected administrator account password on selected Child Sites
