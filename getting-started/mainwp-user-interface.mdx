...
MainWP Dashboard 6.2 adds searchable shortcuts to MainWP pages through the Command Palette. Press **Command + K** on Mac or **Ctrl + K** on Windows/Linux, or click the shortcut button in the header. Type a page or section name, then select a result to open it.

This feature requires WordPress 6.9 or later on your Dashboard site. See [MainWP Command Palette](/dashboard/overview/mainwp-command-palette) for instructions and search examples.

### Header Elements

![MainWP Dashboard header in dark mode with Command Palette, Sync, Add, Layout, Page Settings, site shortcuts, theme, and user controls](/images/getting-started/header-elements-command-palette-dark.svg)

| Element | Function |
|---------|----------|
| Command Palette | Search for and open MainWP pages using **Command + K** on Mac or **Ctrl + K** on Windows/Linux. See [MainWP Command Palette](/dashboard/overview/mainwp-command-palette). |
