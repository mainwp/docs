...
description: >-
  MainWP registers 62 abilities into WordPress Core's Abilities API framework for programmatic site management via AI agents and automation tools. The Cache Control extension adds 8 more.
---
...
MainWP Dashboard registers 62 abilities into this framework across five categories. Individual MainWP extensions can register additional categories: the [Cache Control extension](/add-ons/performance/cache-control-extension) adds 8 abilities under `mainwp-cache-control`. This integration enables AI agents, automation platforms, and external tools to discover what MainWP can do and execute those capabilities through a consistent interface.
...
| `mainwp-cache-control` | 8 | Cache Control extension (requires Cache Control 5.3.0+) |
...
<CardGroup cols={2}>
  ...
  <Card title="Cache Control Abilities" icon="bolt" href="/api-reference/abilities-api/cache-control">
    8 abilities from the Cache Control extension
  </Card>
</CardGroup>
