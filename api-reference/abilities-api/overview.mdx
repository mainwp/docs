...
| `mainwp-custom-dashboard` | 4 | Custom Dashboard snippet inspection and revision-bound edits (requires the [Custom Dashboard Extension](/add-ons/development/mainwp-custom-dashboard-extension) 5.2.0+) |
...
<CardGroup cols={2}>
  ...
  <Card title="Custom Dashboard Abilities" icon="code" href="/api-reference/abilities-api/custom-dashboard">
    4 abilities for Custom Dashboard snippets
  </Card>
</CardGroup>
