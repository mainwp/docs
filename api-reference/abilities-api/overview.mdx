...
Cache Control uses the `mainwp/` namespace. Its abilities include cache status reads, policy changes, Cloudflare credential validation, and single-site cache purging.
