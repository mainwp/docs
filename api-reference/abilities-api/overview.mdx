...
description: >-
  MainWP Dashboard registers 62 abilities into WordPress Core's Abilities API framework. Advanced Uptime Monitor adds 7, and other installed extensions can add more.
---
...
MainWP Dashboard registers 62 abilities into this framework across five categories. With Advanced Uptime Monitor active, those two products expose 69 abilities across six categories. Other MainWP extensions can register additional categories, so 69 is not the extension-inclusive total. This integration enables AI agents, automation platforms, and external tools to discover what MainWP can do and execute those capabilities through a consistent interface.
...
Extensions register categories of their own. For example, this category appears once Advanced Uptime Monitor is installed:

| Category | Abilities | Description |
|----------|-----------|-------------|
| `mainwp-advanced-uptime-monitor` | 7 | Uptime monitors, from the Advanced Uptime Monitor extension |
...
<CardGroup cols={2}>
  ...
  <Card title="Uptime Monitor Abilities" icon="heart-pulse" href="/api-reference/abilities-api/uptime-monitors">
    7 abilities from the Advanced Uptime Monitor extension
  </Card>
</CardGroup>
