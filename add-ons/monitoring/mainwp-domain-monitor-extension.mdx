...
Version 5.3.0 lets automation view saved domain expiry details, manage monitoring settings, update manually entered domain information, and request domain checks. A failed settings or domain-information save shows an error instead of appearing to succeed. Domain lookup replies that do not match the requested domain are not saved, and notification emails safely display site and domain details.
