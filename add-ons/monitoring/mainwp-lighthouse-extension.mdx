...
/>
<Info>
**Integration Add-on** - This add-on connects MainWP Dashboard to the Google PageSpeed Insights API. No third-party WordPress plugin is required.
</Info>
...
- [WP Rocket Integration](/add-ons/performance/rocket-extension) - Advanced caching tools
