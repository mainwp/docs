...
You can use WordPress Abilities to view Lighthouse observations, audit history, and schedule state for sites you can access. You can request or cancel an audit, and manage Lighthouse policies globally or for an individual site.
