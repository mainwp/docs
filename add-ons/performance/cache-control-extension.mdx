...
Cloudflare credentials saved by earlier versions migrate safely to encrypted storage.
</Note>
...
Bulk purges validate every selected site and report the result for each site.
...
The MainWP Abilities API also exposes cache status and purge information for connected sites.
