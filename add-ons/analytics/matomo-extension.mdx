...
- Manage Matomo through MainWP Abilities.
- Matomo management requests are processed on a schedule.
- Existing Matomo connection settings and site data are migrated for the new management features.
- Matomo data is removed when you delete a managed site.
