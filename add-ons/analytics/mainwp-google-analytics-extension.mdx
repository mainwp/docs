...
Website assignments remain in place when you refresh analytics data or reconnect a Google account.
...
The Manage Accounts page identifies sign-in accounts that need verification or reconnection.
