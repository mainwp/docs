...
MainWP actions can view Search Console connections and properties, manage site mappings and refresh settings, and request refreshes. When a connection refreshes, its property assignments stay in sync.

Scheduled refreshes do not overlap and report their outcome. Site selection and data views only show sites the current user is permitted to access.
