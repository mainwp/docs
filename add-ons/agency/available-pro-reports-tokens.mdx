...
- Add-on-specific tokens for analytics and security
...
## Add-on-Specific Tokens

These tokens require specific MainWP add-ons to be installed and activated.
...
<AccordionGroup>
  ...
  <Accordion title="Fathom Integration Tokens" icon="chart-line">
    | Token | Description |
    |-------|-------------|
  ...
  <Accordion title="Google Search Console Tokens" icon="magnifying-glass-chart">
    | Token | Description |
    |-------|-------------|
    | `[gsc.startdate]` | Start date of the GSC reporting window (based on the **Graphs display interval** setting) |
    | `[gsc.enddate]` | End date of the GSC reporting window |
  ...
  <Accordion title="Wordfence Integration Tokens" icon="shield">
    #### Sections
  ...
  <Accordion title="Virusdie Integration Tokens" icon="virus-slash">
    #### Sections
  ...
  <Accordion title="Solid Security Integration Tokens" icon="lock">
    #### Sections
  ...
  <Accordion title="Lighthouse Integration Tokens" icon="lighthouse">
    #### Desktop
  ...
  <Accordion title="Atarim Integration Tokens" icon="tasks">
    | Token | Description |
    |-------|-------------|
