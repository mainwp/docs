...
<iframe
  ...
  src="https://www.youtube.com/embed/nI-TrJia_aA"
  title="MainWP WooCommerce Status Add-on Walkthrough"
  frameBorder="0"
...
-   **Sales Last 7 Days** - Sales from today and the previous six calendar days
-   **Sales This Month** - Sales from the beginning of the current month
-   **Top Seller This Month** - The highest-selling product in the current month
...
The **Sales Last 7 Days** column sorts by its numeric sales value. This metric requires MainWP Child 6.1.7 or later on the connected site.
