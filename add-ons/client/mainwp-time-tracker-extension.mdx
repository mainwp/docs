...
Task counters on Sites and Clients reflect the tasks for that site. Requests use the same request ID across responses, and invalid flags or unauthorized attempts return specific errors.
