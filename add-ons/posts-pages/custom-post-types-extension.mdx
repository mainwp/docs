...
- WordPress Abilities API support lets authorized automation tools manage custom post type content across child sites.
- Publishing checks site access and validates request data before sending content to child sites.
