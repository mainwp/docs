...
<div
  ...
  data-purchase-url="https://mainwp.com/add-on/time-capsule/"
  ...
  data-integrates-with="Backup and Staging by WP Time Capsule"
...
- Installing the add-on and WP Time Capsule plugin
...
The MainWP Time Capsule Extension needs to be installed only on your MainWP Dashboard site. You can [install it as any other MainWP add-on.](/dashboard/overview/manage-extensions#install-add-ons)
