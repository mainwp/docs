...
<div
  ...
  data-integrates-with="WP Staging"
...
The MainWP Staging Extension needs to be installed only on your MainWP Dashboard site. You can [install it as any other MainWP add-on.](/dashboard/overview/manage-extensions#install-add-ons)

### Installing the Plugin

For the proper use of the MainWP Staging Extension, you need to install and activate the WP Staging plugin on your child sites. The add-on also detects WP Staging Pro when it is installed and active.
...
![Go to the MainWP > Sites > Updates page](/images/add-ons/staging-updates-filter.png)
